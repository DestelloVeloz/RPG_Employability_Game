/*:
 * @plugindesc (v3.00) This Plugin allows you to have more control over your TP system and have a dynamic Max TP stat.
 * @author SumRndmDde
 *
...
SRD.TP.preserveTp = String(PluginManager.parameters('SRD_TPUpgrade')['Perserve TP?']).trim().toLowerCase() === 'true';
...
Game_Action.prototype.executeTPDamage = function(target, critical) {
	...
	damage = this.applyVariance(damage, 10);
