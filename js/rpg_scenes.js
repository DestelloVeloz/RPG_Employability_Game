...
Scene_Menu.prototype.commandEndGame = function() {
    this.fadeOutAll();
    SceneManager.exit();
};
...
function Scene_EndGame() {
    this.initialize.apply(this, arguments);
}
Scene_EndGame.prototype.commandEndGame = function() {
    this.fadeOutAll();
    SceneManager.exit();
};
...
Scene_Gameover.prototype.goendGame = function() {
    SceneManager.exit();
};
