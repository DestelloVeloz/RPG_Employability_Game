...
Window_MenuCommand.prototype.addEndGameCommand = function() {
    var enabled = this.isEndGameEnabled();
    this.addCommand(TextManager.endGame, 'endGame', enabled);
};
...
Window_MenuCommand.prototype.isEndGameEnabled = function() {
    return true;
};
